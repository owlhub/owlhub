        ...
        <div className="mt-4 p-4 rounded-lg border" style={{ borderColor: 'var(--border-color)' }}>
          ...
          <div className="mt-4 flex justify-end">
            <button 
              ...
              className="rounded-md border-0 transition-colors flex items-center justify-center font-medium text-sm h-10 px-4 mr-2"
              style={{ 
                background: 'var(--card-bg)', 
                color: 'var(--foreground)',
            ...
            <button 
              ...
              className="rounded-md border-0 transition-colors flex items-center justify-center font-medium text-sm h-10 px-4"
              style={{ 
